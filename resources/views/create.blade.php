                    ...
                    <section class="text-gray-600 body-font relative">
                        <div class="container px-5 pt-4 pb-12 mx-auto">
                            <div class="flex flex-col text-center w-full mb-12">
                                <h1 class="sm:text-2xl text-md font-medium">参考書の登録</h1>
                            </div>
                                ...
                                <div class="lg:w-1/2 md:w-2/3 mx-auto">
                                    <div class="flex flex-wrap -m-2">
                                        ...
                                        <div class="p-4 w-full">
                                            <button type="submit"
                                                class="flex mx-auto text-white bg-indigo-500 border-0 py-2 px-6 focus:outline-none hover:bg-indigo-600 rounded text-lg">保存</button>
                                        </div>
                                    </div>
                                </div>
                            </form>
