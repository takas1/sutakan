                ...
                <div class="p-4">
                    <section class="text-gray-600 body-font">
                        <div class="container px-5 py-4 mx-auto">
                            ...
                            <div class="mb-4 ml-4">
                                <a href="{{ route('create') }}" class="text-blue-500">本を登録</a>
                            </div>
                                ...
                                <div class="p-4 md:w-1/3">
                                    <div class="flex rounded-lg h-full bg-slate-50 shadow-md hover:shadow-lg p-8 flex-col">
                                        <div class="flex items-center mb-6">
                                            ...
                                            <h2 class="text-gray-900 text-lg font-medium">ここだけの数学</h2>
                                        </div>
                                        <div class="flex-grow">
                                            ...
                                            <a class="mt-3 text-blue-500 inline-flex items-center">check
                                ...
                                <div class="p-4 md:w-1/3">
                                    <div class="flex rounded-lg h-full bg-slate-50 shadow-md hover:shadow-lg p-8 flex-col">
                                        <div class="flex items-center mb-3">
                                            ...
                                            <h2 class="text-gray-900 text-lg title-font font-medium">ここだけの数学</h2>
                                        </div>
                                        <div class="flex-grow">
                                            <p class="leading-relaxed text-base">
                                                学習期限<br>
