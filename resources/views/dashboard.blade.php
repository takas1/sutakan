                    ...
                    <section class="text-gray-600 body-font">
                        <div class="container px-5 py-4 mx-auto">
                            ...
                            <div class="flex justify-between mb-4 ml-4">
                                <button type="button" onclick="location.href='{{ route('books.create') }}'"
                                    class="text-white bg-indigo-500 border-0 py-2 px-4 focus:outline-none hover:bg-indigo-600 rounded">
                                    本を登録
                                </button>
                                <button type="button" onclick="location.href='{{ route('trash.index') }}'"
                                    class="mr-4 text-indigo-600 inline-flex items-center">
                                    削除した本はこちら
                            ...
                            <div class="flex flex-wrap -m-4">
                                ...
                                <div class="p-4 md:w-1/3">
                                    <div
                                        class="flex rounded-lg h-full bg-slate-50 shadow-md hover:shadow-lg p-8 flex-col">
                                        ...
                                        <div class="flex-grow">
                                            ...
                                            <div class="flex justify-between">
                                                <button type="button"
                                                    ...
                                                    class="mt-3 text-blue-500 inline-flex items-center">確認
